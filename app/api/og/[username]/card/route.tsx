  ...
  if (result.status !== "ok") {
    ...
    return new ImageResponse(
      <StatusImage message={isRateLimited ? "Transfer market busy — try again shortly" : "Player not found"} />,
      {
        ...
        // Never let a transient "busy" render stick around as long as a
        // genuine 24h card cache — a short s-maxage means the next camo
        // refresh (README embeds) or export view tries again soon.
