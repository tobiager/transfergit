        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="font-table bg-surface-elevated text-xs uppercase tracking-wide text-muted">
              <th className="px-4 py-2 text-left font-semibold">Temporada</th>
              <th className="px-4 py-2 text-left font-semibold">Salida</th>
              <th className="px-4 py-2 text-left font-semibold">Llegada</th>
