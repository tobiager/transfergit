...
// 11-player squad — so the skeleton-to-real swap doesn't jump.
function SquadPitchSkeleton() {
  return (
    <div className="relative mx-auto aspect-[68/118] w-full max-w-[36rem] rounded-xl border border-border bg-pitch-elevated">
...
// shimmer placeholder in the exact grid cell the real content lands in.
  ...
  return (
    <>
      <div className="lg:col-start-8 lg:col-span-5 lg:row-start-1">
        <header className="rounded-xl tm-card px-5 py-4 text-center sm:text-left">
          ...
          <h1 className="mt-1 line-clamp-2 break-words font-display text-2xl uppercase leading-[1.05] tracking-tight md:text-3xl">
            {owner}/{repo}
          </h1>
          <div className="mt-2 flex flex-col items-center gap-1 sm:flex-row sm:items-baseline sm:gap-4">
            <div className="h-8 w-28 animate-pulse rounded bg-surface md:h-9 md:w-32" />
